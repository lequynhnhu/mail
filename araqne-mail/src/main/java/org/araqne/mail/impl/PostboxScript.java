...
public class PostboxScript implements Script {
	...
	public void register(String[] args) {
		try {
			...
			logger.error("araqne-mail: configuration failed", e);
		}
	}
	...
	public void unregister(String[] args) {
		try {
			...
			logger.error("araqne-mail: cannot remove imap configuration", e);
		}
	}
	...
	public void disconnect(String[] args) {
		...
		try {
			...
			logger.error("araqne-mail: cannot close imap", e);
		}
	}
}
